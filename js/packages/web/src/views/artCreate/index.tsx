...
export const ArtCreateView = () => {
  ...
  const mint = async () => {
    const metadata = {
      ...
      nautIDNumber: attributes.nautIDNumber,
      nautSuit: attributes.nautSuit,
      nautVisor: attributes.nautVisor,
      nautBackground: attributes.nautBackground,
      nautOrientation: attributes.nautOrientation,
      nautPatchOne: attributes.nautPatchOne,
      nautPatchTwo: attributes.nautPatchTwo,
      nautSecondaryColor: attributes.nautSecondaryColor,
      nautDubsTrips: attributes.nautDubsTrips,
      nautRank: attributes.nautRank,
      properties: {
